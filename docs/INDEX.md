...
- [Azure Pipeline Setup](./pipeline_guide/AZURE_PIPELINE_SETUP.md)
...
### Requirements
- [Functional Requirements](./requirements/Actual-design-plan/functional-requirements.md)
- [Non-Functional Requirements](./requirements/Actual-design-plan/non-functional-requirements.md)
- [Database Schema](./requirements/database-design/database-schema.md)
...
### By Feature
- **F100-F101 (User Auth)**: See [Merge Review](./MERGE_REVIEW_F100_F101.md)
- **F102 (User Management)**: See [Security Issues](./Identified_security_issues/)
- **F103-F104 (Menu)**: See [Feature Verification](./en/reports/feature-verification.md)
- **F105-F106 (Order/Payment)**: See [API Specification](./design/04-api-specification.md)
- **F107 (Delivery)**: See [Feature Verification](./en/reports/feature-verification.md)
- **F108-F109 (Reservation)**: See [Test Guides](./testing/)
...
- **Backend**: [Backend Reports](./en/reports/)
- **Testing**: [Test Strategy](./testing/TEST_STRATEGY.md)
...
- **[Documentation Status Report](./DOCUMENTATION_STATUS.md)** - Complete documentation status and organization

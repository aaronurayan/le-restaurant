...
| Language | Guides Index | Status |
|----------|-------------|--------|
| **🇬🇧 English** | [📖 Guides Index](./README.md) | ✅ This file |
| **🇰🇷 한국어** | [📖 가이드 인덱스](../ko/guides/README.md) | ✅ Available |
| **🇯🇵 日本語** | [📖 ガイドインデックス](../ja/guides/README.md) | ✅ Available |
| **🇷🇺 Русский** | [📖 Индекс руководств](../ru/guides/README.md) | ✅ Available |
...
**Available in**: [English](./01-admin-dashboard-access.md) | [한국어](../ko/guides/01-admin-dashboard-access.md)
...
**Available in**: [English](./02-routing-verification.md) | [한국어](../ko/guides/02-routing-verification.md)
...
**Available in**: [English](./03-ux-navigation-improvements.md) | [한국어](../ko/guides/03-ux-navigation-improvements.md)
...
**Available in**: [English](./04-pipeline-improvements.md) | [한국어](../ko/guides/04-pipeline-improvements.md)
...
**Available in**: [English](./05-azure-pipeline-review.md) | [한국어](../ko/guides/05-azure-pipeline-review.md)
...
- **한국어 (Korean)**: `../ko/guides/01-*.md`, `../ko/guides/02-*.md`, etc.
...
3. **For Korean**, navigate to `../ko/guides/` directory with the same number
